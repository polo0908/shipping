...
public class CheckServer extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		Object proIds = session.getAttribute("proIds");
		Object auth = session.getAttribute("auth");
		String pds = "";
		if(!(proIds == null || "".equals(proIds))){
			pds = proIds.toString().substring(1);
		}
...
//				res2.getString("");
			...
			RequestDispatcher homeDispatcher = request.getRequestDispatcher("view/SeeCheck.jsp");
