...
<html>
  ...
  <body>
	<h1 align="left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp出口货物明细单</h1>
  	<h3 align="left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<%=request.getAttribute("sailDateTime")%></h3>
  	<h2>出口企业名称：上海凯融信息科技有限公司</h2>
  	<table border="1"  style="margin-left:0px;margin-top:0px;font-family:宋体;color:black;font-size:13px;text-align:left">
  		<tr>
